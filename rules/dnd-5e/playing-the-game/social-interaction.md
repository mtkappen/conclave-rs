...
During their adventures, player characters meet many different people and face some monsters that would rather talk than fight. In those situations, it's time for social interaction, which takes many forms. For example, you might try to convince a burglar to confess to wrongdoing or try to flatter a guard.

## NPC Attitudes

The Game Master assumes the roles of any nonplayer characters who are participating. An NPC's attitude toward your character is **Friendly**, **Indifferent**, or **Hostile**:
- **Friendly NPCs** are predisposed to help
- **Hostile NPCs** are inclined to hinder
...
- **Active:** You speak directly in character
- **Descriptive:** You describe what your character would say or do
