...
You create a small extradimensional space that exists on the border between planes. The demiplane is a 30-foot cube of empty space with no entrance other than the one you create when casting. You can specify the appearance and basic features of the interior (such as walls, floor, lighting).
