...
## Spell 5 - Polymorph Transmutation
...
- **Air:** Speed 20 feet, fly Speed 60 feet; Melee [one-action] wind, Damage 1d8 bludgeoning, and you can spend an action immediately after a hit to push the target 5 feet with the effects of a successful Shove.
- **Earth:** Speed 30 feet, burrow Speed 20 feet; Melee [one-action] fist, Damage 1d12 bludgeoning plus 1 persistent bleed.
- **Fire:** Speed 40 feet; Melee [one-action] flame, Damage 1d8 fire plus 1 persistent fire damage.
