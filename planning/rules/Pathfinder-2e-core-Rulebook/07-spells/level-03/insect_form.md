...
## Spell 3 - Polymorph Transmutation
**Traditions:** primal  
**Cast:** [two-actions] somatic, verbal  
**Duration:** 1 minute  

You envision a simple bug and transform into a Medium animal battle form. When you cast this spell, choose ant, beetle, centipede, mantis, scorpion, or spider. You can decide the specific type of animal (such as ladybug or scarab for beetle), but this has no effect on the form's Size or statistics. While in this form, you gain the animal trait. You can Dismiss this spell.
...
- **Beetle:** Speed 25 feet; Melee [one-action] mandibles, Damage 2d10 bludgeoning.
...
- **Spider:** darkvision; Speed 25 feet, climb Speed 25 feet; Melee [one-action] fangs, Damage 1d6 piercing plus 1d4 persistent poison; Ranged [one-action] web (range increment 20 feet), Damage entangles the target for 1 round.
