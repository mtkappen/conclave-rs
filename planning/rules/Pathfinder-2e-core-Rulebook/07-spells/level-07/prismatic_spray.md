...
| 4   | Green   | Fortitude| 30 poison damage, enfeebled 1 for 1 minute (poison)  |
| 5   | Blue    | Fortitude| Affected as if by flesh to stone                     |
| 6   | Indigo  | Will     | Confused, as the warp mind spell (mental)            |
| 7   | Violet  | Will     | Slowed 1 for 1 minute; on critical failure, sent to another plane, as plane shift (teleportation) |
