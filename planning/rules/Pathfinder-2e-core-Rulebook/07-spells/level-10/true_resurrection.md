...
**Cast:** 1 hour (material, somatic, verbal); Cost: diamonds worth a total value of the target's level × 5,000 gp  
**Range:** 10 feet; Targets: 1 dead creature  
**Duration:** instantaneous  

You restore a dead creature to life, even if it has been dead for years or its body is missing. Unlike raise dead, this spell doesn't require the body to be present or intact. You create an entirely new body for the target's soul.
